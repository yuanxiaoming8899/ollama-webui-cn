...
<ul dir="auto">
<li><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">🐰 </font></font><a href="https://bun.sh" rel="nofollow"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Bun</font></font></a><font style="vertical-align: inherit;"><font style="vertical-align: inherit;"> &gt;= 1.0.21 或 🐢 </font></font><a href="https://nodejs.org/en" rel="nofollow"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Node.js</font></font></a><font style="vertical-align: inherit;"><font style="vertical-align: inherit;"> &gt;= 20.10</font></font></li>
<li><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">🐍Python </font><font style="vertical-align: inherit;">&gt;= </font></font><a href="https://python.org" rel="nofollow"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">3.11</font></font></a><font style="vertical-align: inherit;"></font></li>
</ul>
<h3 tabindex="-1" dir="auto"><a id="user-content-build-and-install-️" class="anchor" aria-hidden="true" tabindex="-1" href="#build-and-install-️"><svg class="octicon octicon-link" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true"><path d="m7.775 3.275 1.25-1.25a3.5 3.5 0 1 1 4.95 4.95l-2.5 2.5a3.5 3.5 0 0 1-4.95 0 .751.751 0 0 1 .018-1.042.751.751 0 0 1 1.042-.018 1.998 1.998 0 0 0 2.83 0l2.5-2.5a2.002 2.002 0 0 0-2.83-2.83l-1.25 1.25a.751.751 0 0 1-1.042-.018.751.751 0 0 1-.018-1.042Zm-4.69 9.64a1.998 1.998 0 0 0 2.83 0l1.25-1.25a.751.751 0 0 1 1.042.018.751.751 0 0 1 .018 1.042l-1.25 1.25a3.5 3.5 0 1 1-4.95-4.95l2.5-2.5a3.5 3.5 0 0 1 4.95 0 .751.751 0 0 1-.018 1.042.751.751 0 0 1-1.042.018 1.998 1.998 0 0 0-2.83 0l-2.5 2.5a1.998 1.998 0 0 0 0 2.83Z"></path></svg></a><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">构建并安装🛠️</font></font></h3>
<p dir="auto"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">运行以下命令进行安装：</font></font></p>
<div class="highlight highlight-source-shell notranslate position-relative overflow-auto" dir="auto"><pre>git clone https://github.com/ollama-webui/ollama-webui.git
<span class="pl-c1">cd</span> ollama-webui/

<span class="pl-c"><span class="pl-c">#</span> Copying required .env file</span>
cp -RPp example.env .env

<span class="pl-c"><span class="pl-c">#</span> Building Frontend Using Node</span>
npm i
npm run build

<span class="pl-c"><span class="pl-c">#</span> or Building Frontend Using Bun</span>
<span class="pl-c"><span class="pl-c">#</span> bun install</span>
<span class="pl-c"><span class="pl-c">#</span> bun run build</span>

<span class="pl-c"><span class="pl-c">#</span> Serving Frontend with the Backend</span>
<span class="pl-c1">cd</span> ./backend
pip install -r requirements.txt -U
sh start.sh</pre><div class="zeroclipboard-container">
    <clipboard-copy aria-label="Copy" class="ClipboardButton btn btn-invisible js-clipboard-copy m-2 p-0 tooltipped-no-delay d-flex flex-justify-center flex-items-center" data-copy-feedback="Copied!" data-tooltip-direction="w" value="git clone https://github.com/ollama-webui/ollama-webui.git
cd ollama-webui/
...
cd ./backend
pip install -r requirements.txt -U
sh start.sh" tabindex="0" role="button">
      <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-copy js-clipboard-copy-icon">
    <path d="M0 6.75C0 5.784.784 5 1.75 5h1.5a.75.75 0 0 1 0 1.5h-1.5a.25.25 0 0 0-.25.25v7.5c0 .138.112.25.25.25h7.5a.25.25 0 0 0 .25-.25v-1.5a.75.75 0 0 1 1.5 0v1.5A1.75 1.75 0 0 1 9.25 16h-7.5A1.75 1.75 0 0 1 0 14.25Z"></path><path d="M5 1.75C5 .784 5.784 0 6.75 0h7.5C15.216 0 16 .784 16 1.75v7.5A1.75 1.75 0 0 1 14.25 11h-7.5A1.75 1.75 0 0 1 5 9.25Zm1.75-.25a.25.25 0 0 0-.25.25v7.5c0 .138.112.25.25.25h7.5a.25.25 0 0 0 .25-.25v-7.5a.25.25 0 0 0-.25-.25Z"></path>
</svg>
      <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-check js-clipboard-check-icon color-fg-success d-none">
...
<p dir="auto"><font style="vertical-align: inherit;"></font><a href="http://localhost:8080/" rel="nofollow"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">您应该在http://localhost:8080/</font></font></a><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">上启动并运行 Ollama Web UI </font><font style="vertical-align: inherit;">。</font><font style="vertical-align: inherit;">享受！</font><font style="vertical-align: inherit;">😄</font></font></p>
...
<p dir="auto"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">有关如何排除故障和/或加入我们的</font><a href="https://discord.gg/5rJgQTnV4s" rel="nofollow"><font style="vertical-align: inherit;">Ollama Web UI Discord 社区的</font></a><font style="vertical-align: inherit;">信息，请参阅</font></font><a href="/ollama-webui/ollama-webui/blob/main/TROUBLESHOOTING.md"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">TROUBLESHOOTING.md</font></font></a><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">。</font></font><a href="https://discord.gg/5rJgQTnV4s" rel="nofollow"><font style="vertical-align: inherit;"></font></a><font style="vertical-align: inherit;"></font></p>
...
<p dir="auto"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">以下是我们路线图中的一些令人兴奋的任务：</font></font></p>
<ul dir="auto">
<li><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">🌐</font></font><strong><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">网页浏览功能</font></font></strong><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">：体验将网页内容直接无缝集成到聊天中的便利。</font><font style="vertical-align: inherit;">无需离开对话即可轻松浏览和共享信息。</font></font></li>
<li><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">🔄</font></font><strong><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">函数调用</font></font></strong><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">：通过直接在聊天中运行代码来增强您的交互。</font><font style="vertical-align: inherit;">轻松执行功能和命令，增强对话的功能。</font></font></li>
<li><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">⚙️</font></font><strong><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">自定义 Python 后端操作</font></font></strong><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">：通过创建或下载自定义 Python 后端操作来增强您的 Ollama Web UI。</font><font style="vertical-align: inherit;">通过适合您特定需求的定制操作，释放 Web 界面的全部潜力，增强功能和多功能性。</font></font></li>
<li><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">🧠</font></font><strong><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">长期记忆</font></font></strong><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">：见证我们代理中持久记忆的力量。</font><font style="vertical-align: inherit;">当座席记住并参考过去的交互时，享受连续的对话，从而创造更具凝聚力和个性化的用户体验。</font></font></li>
<li><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">🧪</font></font><strong><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">以研究为中心的功能</font></font></strong><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">：为 LLM 和 HCI 领域的研究人员提供全面的 Web UI 来进行用户研究。</font><font style="vertical-align: inherit;">请继续关注正在进行的功能增强（例如调查、分析和参与者跟踪）以促进他们的研究。</font></font></li>
<li><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">📈</font></font><strong><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">用户研究工具</font></font></strong><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">：提供热图和行为跟踪模块等专业工具，使研究人员能够精确捕捉和分析用户行为模式。</font></font></li>
<li><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">📚</font></font><strong><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">增强的文档</font></font></strong><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">：通过改进的、全面的文档提升您的设置和定制体验。</font></font></li>
</ul>
<p dir="auto"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">请随意贡献并帮助我们使 Ollama Web UI 变得更好！</font><font style="vertical-align: inherit;">🙌</font></font></p>
<h2 tabindex="-1" dir="auto"><a id="user-content-supporters-" class="anchor" aria-hidden="true" tabindex="-1" href="#supporters-"><svg class="octicon octicon-link" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true"><path d="m7.775 3.275 1.25-1.25a3.5 3.5 0 1 1 4.95 4.95l-2.5 2.5a3.5 3.5 0 0 1-4.95 0 .751.751 0 0 1 .018-1.042.751.751 0 0 1 1.042-.018 1.998 1.998 0 0 0 2.83 0l2.5-2.5a2.002 2.002 0 0 0-2.83-2.83l-1.25 1.25a.751.751 0 0 1-1.042-.018.751.751 0 0 1-.018-1.042Zm-4.69 9.64a1.998 1.998 0 0 0 2.83 0l1.25-1.25a.751.751 0 0 1 1.042.018.751.751 0 0 1 .018 1.042l-1.25 1.25a3.5 3.5 0 1 1-4.95-4.95l2.5-2.5a3.5 3.5 0 0 1 4.95 0 .751.751 0 0 1-.018 1.042.751.751 0 0 1-1.042.018 1.998 1.998 0 0 0-2.83 0l-2.5 2.5a1.998 1.998 0 0 0 0 2.83Z"></path></svg></a><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">支持者✨</font></font></h2>
...
<h3 tabindex="-1" dir="auto"><a id="user-content-platinum-sponsors-" class="anchor" aria-hidden="true" tabindex="-1" href="#platinum-sponsors-"><svg class="octicon octicon-link" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true"><path d="m7.775 3.275 1.25-1.25a3.5 3.5 0 1 1 4.95 4.95l-2.5 2.5a3.5 3.5 0 0 1-4.95 0 .751.751 0 0 1 .018-1.042.751.751 0 0 1 1.042-.018 1.998 1.998 0 0 0 2.83 0l2.5-2.5a2.002 2.002 0 0 0-2.83-2.83l-1.25 1.25a.751.751 0 0 1-1.042-.018.751.751 0 0 1-.018-1.042Zm-4.69 9.64a1.998 1.998 0 0 0 2.83 0l1.25-1.25a.751.751 0 0 1 1.042.018.751.751 0 0 1 .018 1.042l-1.25 1.25a3.5 3.5 0 1 1-4.95-4.95l2.5-2.5a3.5 3.5 0 0 1 4.95 0 .751.751 0 0 1-.018 1.042.751.751 0 0 1-1.042.018 1.998 1.998 0 0 0-2.83 0l-2.5 2.5a1.998 1.998 0 0 0 0 2.83Z"></path></svg></a><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">白金赞助商🤍</font></font></h3>
<ul dir="auto">
...
</font></font><a href="https://discord.gg/5rJgQTnV4s" rel="nofollow"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Ollama Web UI Discord 社区</font></font></a><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">或
</font></font><a href="https://discord.gg/ollama" rel="nofollow"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Ollama Discord 社区</font></font></a><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">与我们联系！</font><font style="vertical-align: inherit;">🤝</font></font></p>
<hr>
<p dir="auto"><font style="vertical-align: inherit;"></font><a href="https://github.com/tjbck"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">由Timothy J. Baek</font></font></a><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">创建</font><font style="vertical-align: inherit;">- 让我们一起让 Ollama Web UI 变得更加令人惊叹！</font><font style="vertical-align: inherit;">💪</font></font></p>
</article></div>
